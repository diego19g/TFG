...
@section('content')
<main>
<div class="texto_carta"><p>Échale un vistazo a nuestra carta y disfruta de nuestra variada comida de la mejor calidad</p></div>
<div style="margin-bottom:70px;"><a class="btn btn-lg btn-home centrado enlace_login_home" href="{{ route('login') }}">Empezar a pedir</a></div>
<br>
